...
<p>The IQR overcomes the dependency on extreme values. It is the range for the middle 50% of the data, measuring the spread between the 25th percentile (Q1) and 75th percentile (Q3).</p>
<p class="formula">IQR = Q3 - Q1</p>

<h5><strong>Detailed Example: IQR Calculation</strong></h5>
<p>Consider a researcher's sample data with mean = 5: <strong>3, 5, 12, 3, 2</strong></p>

<p><strong>Step 1:</strong> Arrange data in ascending order</p>
<p>Original: 3, 5, 12, 3, 2 → Ordered: <strong>2, 3, 3, 5, 12</strong></p>

<p><strong>Step 2:</strong> Find the quartiles (n = 5)</p>
<ul>
<li><strong>Q1 (25th percentile):</strong> The value that separates the lowest 25% of data = <strong>3</strong></li>
<li><strong>Q3 (75th percentile):</strong> The value that separates the lowest 75% of data = <strong>5</strong></li>
</ul>

<p><strong>Step 3:</strong> Calculate IQR</p>
<p class="formula">IQR = Q3 - Q1 = 5 - 3 = 2</p>

<p><strong>Key Benefits of IQR:</strong></p>
<ul>
<li><strong>Resistant to outliers:</strong> Unlike the range (12 - 2 = 10), the IQR isn't affected by extreme values</li>
<li><strong>Focuses on central spread:</strong> Measures variability of the middle 50% of data</li>
<li><strong>Used in outlier detection:</strong> Values beyond Q1 - 1.5(IQR) or Q3 + 1.5(IQR) are potential outliers</li>
</ul>
